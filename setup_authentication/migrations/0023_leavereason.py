...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('setup_authentication', '0022_teachernotification_delete_leave_reason'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teacher', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='setup_authentication.teacher')),
            ],
        ),
    ]
